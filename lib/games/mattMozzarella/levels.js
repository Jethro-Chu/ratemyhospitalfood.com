...
const level2 = {
    ...
    geysers: [
        ...
        // Overcooked noodle whips up out of the sauce river you float across
        { x: 3252, y: 216, w: 40, kind: 'noodle', period: 2400, onTime: 1000, maxH: 120, phase: 1200 },
    ],
    ...
    enemies: [
        ...
        { type: 'meatball', x: 3100, y: 192, minX: 3044, maxX: 3206, speed: 90 }, // rolls fast across the landing
        { type: 'fry',      x: 3140, y: 136, minX: 3122, maxX: 3178, speed: 34 }, // on the tray
        { type: 'fry',      x: 2840, y: 146, minX: 2822, maxX: 2912, speed: 40 }, // on a lasagna ramp
    ],
