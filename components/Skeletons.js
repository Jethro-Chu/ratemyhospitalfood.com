...
export function Shimmer({ className = '' }) {
  return <div className={`animate-pulse rounded-xl bg-cream-200/80 ${className}`} aria-hidden="true" />;
}

export function HospitalCardSkeleton() {
  return (
    <div className="rounded-3xl bg-cream-50 border border-ink-900/10 p-5 shadow-warm-sm" aria-hidden="true">
...
export function ReviewCardSkeleton() {
  return (
    <div className="rounded-3xl bg-cream-50 border border-ink-900/10 p-5 sm:p-6 shadow-warm-sm" aria-hidden="true">
